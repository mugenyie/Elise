...
class accountsTest(BaseTestCase):
  ...
  def test_user_creation(self):
    ...
    u = self.user
    res = self.client.post('/v1/accounts/',headers={'Content-Type': 'application/json'}, data=json.dumps(u.__dict__))
  ...
  #   res = self.client.post('/v1/accounts/', headers={'Content-Type': 'application/json'}, data=json.dumps(self.user))
  #   self.assertEqual(res.status_code, 201)
  #   res = self.client.post('/v1/accounts/', headers={'Content-Type': 'application/json'}, data=json.dumps(self.user))
  #   json_data = json.loads(res.data)
  ...
  #   }
  #   res = self.client.post('/v1/accounts/', headers={'Content-Type': 'application/json'}, data=json.dumps(user1))
  #   json_data = json.loads(res.data)
  #   self.assertEqual(res.status_code, 400)
  ...
  #   res = self.client.post('/v1/accounts/', headers={'Content-Type': 'application/json'}, data=json.dumps(self.user))
  #   self.assertEqual(res.status_code, 201)
  #   res = self.client.post('/v1/accounts/login', headers={'Content-Type': 'application/json'}, data=json.dumps(self.user))
  #   json_data = json.loads(res.data)
  #   self.assertTrue(json_data.get('auth_token'))
  ...
  #   res = self.client.post('/v1/accounts/', headers={'Content-Type': 'application/json'}, data=json.dumps(self.user))
  #   self.assertEqual(res.status_code, 201)
  #   res = self.client.post('/v1/accounts/login', headers={'Content-Type': 'application/json'}, data=json.dumps(user1))
  #   json_data = json.loads(res.data)
  ...
  #   res = self.client.get('/v1/accounts/me', headers={'Content-Type': 'application/json', 'auth_token': auth_token})
  #   json_data = json.loads(res.data)
  #   self.assertEqual(res.status_code, 200)
  ...
  #   self.assertEqual(res.status_code, 201)
  #   auth_token = json.loads(res.data).get('auth_token')
  #   res = self.client.put('/v1/accounts/me', headers={'Content-Type': 'application/json', 'auth_token': auth_token}, data=json.dumps(user1))
  #   json_data = json.loads(res.data)
  #   self.assertEqual(res.status_code, 200)
  ...
  #   self.assertEqual(res.status_code, 201)
  #   auth_token = json.loads(res.data).get('auth_token')
  #   res = self.client.delete('/v1/accounts/me', headers={'Content-Type': 'application/json', 'auth_token': auth_token})
